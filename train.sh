...
# Modified for instruments
#CUDA_VISIBLE_DEVICES=0,1 python3.6 train.py --device_ids 0 1 --num_workers 8 --batch_size 12 --folds 0 1 2 3 --problem_type instruments --lr 3e-5 --model UNet11 --jaccard_weight 0.3 --max_epochs 100 --model_save_dir ../model_ckpt-instruments --input_height 512 --input_width 640 --tb_log True --log_filename ../model_ckpt-instruments/log_file.txt

#for mf-tapnet
#CUDA_VISIBLE_DEVICES=0,1 python3.6 train.py --device_ids 0 1 --num_workers 8 --batch_size 10 --folds 0 1 2 3 --problem_type binary --lr 3e-5 --model TAPNet --mf True --jaccard_weight 0.3 --max_epochs 100 --model_save_dir ../model_ckpt-mftapnet-binary --input_height 512 --input_width 640 --tb_log True --log_filename log_file

CUDA_VISIBLE_DEVICES=0,1 python3.6 train.py --device_ids 0 1 --num_workers 8 --batch_size 6 --folds 0 1 2 3 --problem_type binary --lr 3e-5 --model TAPNet --mf True --jaccard_weight 0.3 --max_epochs 100 --model_save_dir ../model_ckpt-mftapnet-EETS-binary --input_height 512 --input_width 640 --tb_log True --log_filename log_file
